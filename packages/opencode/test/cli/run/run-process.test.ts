...
describe("opencode run (non-interactive subprocess)", () => {
  ...
  // Assert that the command itself reports the invalid model rather than being
  // killed by the subprocess harness. A strict wall-clock assertion is flaky on
  // shared CI runners because Bun startup and module compilation contend with the
  // other subprocess tests, while the timeout marker is an exact hang oracle.
  cliIt.live(
