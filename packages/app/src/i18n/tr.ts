...
export const dict = {
  ...
  "marketplace.component.enabled": "Etkin",
  "marketplace.component.disabled": "Devre dışı",
  "marketplace.component.plugin.title": "Eklenti",
  "marketplace.component.plugin.description": "Bu eklentideki tüm özellikleri açın veya kapatın.",
  "marketplace.component.plugin.toggle": "{{name}} eklentisini değiştir",
  "marketplace.component.plugin.enabled": "{{name}} etkinleştirildi",
  "marketplace.component.plugin.disabled": "{{name}} devre dışı bırakıldı",
  "marketplace.component.skills.title": "Beceriler",
  "marketplace.component.skills.description": "Aracıların kullanabileceği paket iş akışlarını seçin.",
  "marketplace.component.skill.toggle": "{{name}} becerisini değiştir",
  "marketplace.component.skill.enabled": "{{name}} becerisi etkinleştirildi",
  "marketplace.component.skill.disabled": "{{name}} becerisi devre dışı bırakıldı",
  "marketplace.component.mcp.title": "MCP sunucuları",
  "marketplace.component.mcp.description":
    "Etkin sunucular eklentiyle otomatik başlar. Burada kapattığınız sunucular kapalı kalır.",
  "marketplace.component.mcp.toggle": "{{name}} MCP sunucusunu değiştir",
  "marketplace.component.mcp.enabled": "{{name}} MCP sunucusu etkinleştirildi",
  "marketplace.component.mcp.disabled": "{{name}} MCP sunucusu devre dışı bırakıldı",
  "marketplace.toggle.conflict.title": "Eklenti ayarları değiştirilemedi",
  "marketplace.toggle.conflict.description": "Önce çakışan ayarları çözün: {{settings}}",
  "marketplace.toggle.preserved.title": "Ayarlar korundu",
  "marketplace.toggle.preserved.description": "Kullanıcının değiştirdiği ayarlar korundu: {{settings}}",
