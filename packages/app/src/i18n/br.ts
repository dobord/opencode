export const dict = {
  "marketplace.component.enabled": "Ativado",
  "marketplace.component.disabled": "Desativado",
  "marketplace.component.plugin.title": "Plugin",
  "marketplace.component.plugin.description": "Ative ou desative todos os recursos deste plugin.",
  "marketplace.component.plugin.toggle": "Alternar plugin {{name}}",
  "marketplace.component.plugin.enabled": "{{name}} ativado",
  "marketplace.component.plugin.disabled": "{{name}} desativado",
  "marketplace.component.skills.title": "Skills",
  "marketplace.component.skills.description": "Escolha quais fluxos incluídos ficam disponíveis para os agentes.",
  "marketplace.component.skill.toggle": "Alternar skill {{name}}",
  "marketplace.component.skill.enabled": "Skill {{name}} ativada",
  "marketplace.component.skill.disabled": "Skill {{name}} desativada",
  "marketplace.component.mcp.title": "Servidores MCP",
  "marketplace.component.mcp.description":
    "Servidores ativados iniciam automaticamente com o plugin. Os desativados aqui permanecem desligados.",
  "marketplace.component.mcp.toggle": "Alternar servidor MCP {{name}}",
  "marketplace.component.mcp.enabled": "Servidor MCP {{name}} ativado",
  "marketplace.component.mcp.disabled": "Servidor MCP {{name}} desativado",
  "marketplace.toggle.conflict.title": "Não foi possível alterar as configurações do plugin",
  "marketplace.toggle.conflict.description": "Resolva primeiro as configurações em conflito: {{settings}}",
  "marketplace.toggle.preserved.title": "Configurações preservadas",
  "marketplace.toggle.preserved.description": "Configurações alteradas pelo usuário foram preservadas: {{settings}}",
