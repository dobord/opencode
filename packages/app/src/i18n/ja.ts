export const dict = {
  ...
  "marketplace.component.enabled": "有効",
  "marketplace.component.disabled": "無効",
  "marketplace.component.plugin.title": "プラグイン",
  "marketplace.component.plugin.description": "このプラグインのすべての機能を有効または無効にします。",
  "marketplace.component.plugin.toggle": "プラグイン {{name}} を切り替え",
  "marketplace.component.plugin.enabled": "{{name}} を有効にしました",
  "marketplace.component.plugin.disabled": "{{name}} を無効にしました",
  "marketplace.component.skills.title": "スキル",
  "marketplace.component.skills.description": "エージェントが利用できる同梱ワークフローを選択します。",
  "marketplace.component.skill.toggle": "スキル {{name}} を切り替え",
  "marketplace.component.skill.enabled": "スキル {{name}} を有効にしました",
  "marketplace.component.skill.disabled": "スキル {{name}} を無効にしました",
  "marketplace.component.mcp.title": "MCP サーバー",
  "marketplace.component.mcp.description":
    "有効なサーバーはプラグインとともに自動起動します。ここで無効にしたサーバーは停止したままです。",
  "marketplace.component.mcp.toggle": "MCP サーバー {{name}} を切り替え",
  "marketplace.component.mcp.enabled": "MCP サーバー {{name}} を有効にしました",
  "marketplace.component.mcp.disabled": "MCP サーバー {{name}} を無効にしました",
  "marketplace.toggle.conflict.title": "プラグイン設定を変更できませんでした",
  "marketplace.toggle.conflict.description": "先に競合する設定を解決してください: {{settings}}",
  "marketplace.toggle.preserved.title": "設定を保持しました",
  "marketplace.toggle.preserved.description": "ユーザーが変更した設定を保持しました: {{settings}}",
