export const dict = {
  "marketplace.component.enabled": "Aktiveret",
  "marketplace.component.disabled": "Deaktiveret",
  "marketplace.component.plugin.title": "Plugin",
  "marketplace.component.plugin.description": "Slå alle funktioner i dette plugin til eller fra.",
  "marketplace.component.plugin.toggle": "Skift plugin {{name}}",
  "marketplace.component.plugin.enabled": "{{name}} aktiveret",
  "marketplace.component.plugin.disabled": "{{name}} deaktiveret",
  "marketplace.component.skills.title": "Færdigheder",
  "marketplace.component.skills.description": "Vælg hvilke medfølgende arbejdsgange agenter kan bruge.",
  "marketplace.component.skill.toggle": "Skift færdighed {{name}}",
  "marketplace.component.skill.enabled": "Færdigheden {{name}} er aktiveret",
  "marketplace.component.skill.disabled": "Færdigheden {{name}} er deaktiveret",
  "marketplace.component.mcp.title": "MCP-servere",
  "marketplace.component.mcp.description":
    "Aktiverede servere starter automatisk med pluginet. Servere, du slår fra her, forbliver slukket.",
  "marketplace.component.mcp.toggle": "Skift MCP-server {{name}}",
  "marketplace.component.mcp.enabled": "MCP-serveren {{name}} er aktiveret",
  "marketplace.component.mcp.disabled": "MCP-serveren {{name}} er deaktiveret",
  "marketplace.toggle.conflict.title": "Pluginindstillingerne kunne ikke ændres",
  "marketplace.toggle.conflict.description": "Løs først de modstridende indstillinger: {{settings}}",
  "marketplace.toggle.preserved.title": "Indstillinger bevaret",
  "marketplace.toggle.preserved.description": "Brugerændrede indstillinger blev bevaret: {{settings}}",
