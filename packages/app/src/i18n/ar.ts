export const dict = {
  "marketplace.component.enabled": "مفعّل",
  "marketplace.component.disabled": "معطّل",
  "marketplace.component.plugin.title": "الإضافة",
  "marketplace.component.plugin.description": "فعّل أو عطّل جميع إمكانات هذه الإضافة.",
  "marketplace.component.plugin.toggle": "تبديل الإضافة {{name}}",
  "marketplace.component.plugin.enabled": "تم تفعيل {{name}}",
  "marketplace.component.plugin.disabled": "تم تعطيل {{name}}",
  "marketplace.component.skills.title": "المهارات",
  "marketplace.component.skills.description": "اختر مسارات العمل المضمّنة المتاحة للوكلاء.",
  "marketplace.component.skill.toggle": "تبديل المهارة {{name}}",
  "marketplace.component.skill.enabled": "تم تفعيل المهارة {{name}}",
  "marketplace.component.skill.disabled": "تم تعطيل المهارة {{name}}",
  "marketplace.component.mcp.title": "خوادم MCP",
  "marketplace.component.mcp.description":
    "تبدأ الخوادم المفعّلة تلقائيًا مع الإضافة. وتبقى الخوادم التي تعطلها هنا متوقفة.",
  "marketplace.component.mcp.toggle": "تبديل خادم MCP ‏{{name}}",
  "marketplace.component.mcp.enabled": "تم تفعيل خادم MCP ‏{{name}}",
  "marketplace.component.mcp.disabled": "تم تعطيل خادم MCP ‏{{name}}",
  "marketplace.toggle.conflict.title": "تعذر تغيير إعدادات الإضافة",
  "marketplace.toggle.conflict.description": "حل تعارضات الإعدادات أولًا: {{settings}}",
  "marketplace.toggle.preserved.title": "تم الاحتفاظ بالإعدادات",
  "marketplace.toggle.preserved.description": "تم الاحتفاظ بالإعدادات التي عدّلها المستخدم: {{settings}}",
