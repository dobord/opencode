export const dict = {
  "marketplace.component.enabled": "Увімкнено",
  "marketplace.component.disabled": "Вимкнено",
  "marketplace.component.plugin.title": "Плагін",
  "marketplace.component.plugin.description": "Увімкнути або вимкнути всі можливості цього плагіна.",
  "marketplace.component.plugin.toggle": "Перемкнути плагін {{name}}",
  "marketplace.component.plugin.enabled": "Плагін {{name}} увімкнено",
  "marketplace.component.plugin.disabled": "Плагін {{name}} вимкнено",
  "marketplace.component.skills.title": "Скіли",
  "marketplace.component.skills.description": "Виберіть доступні агентам сценарії з цього плагіна.",
  "marketplace.component.skill.toggle": "Перемкнути скіл {{name}}",
  "marketplace.component.skill.enabled": "Скіл {{name}} увімкнено",
  "marketplace.component.skill.disabled": "Скіл {{name}} вимкнено",
  "marketplace.component.mcp.title": "MCP-сервери",
  "marketplace.component.mcp.description":
    "Увімкнені сервери запускаються автоматично разом із плагіном. Вимкнені тут сервери залишаються вимкненими.",
  "marketplace.component.mcp.toggle": "Перемкнути MCP-сервер {{name}}",
  "marketplace.component.mcp.enabled": "MCP-сервер {{name}} увімкнено",
  "marketplace.component.mcp.disabled": "MCP-сервер {{name}} вимкнено",
  "marketplace.toggle.conflict.title": "Не вдалося змінити налаштування плагіна",
  "marketplace.toggle.conflict.description": "Спочатку усуньте конфлікти налаштувань: {{settings}}",
  "marketplace.toggle.preserved.title": "Налаштування збережено",
  "marketplace.toggle.preserved.description": "Змінені користувачем налаштування збережено: {{settings}}",
