export const dict = {
  ...
  "marketplace.component.enabled": "Включено",
  "marketplace.component.disabled": "Выключено",
  "marketplace.component.plugin.title": "Плагин",
  "marketplace.component.plugin.description": "Включить или выключить все возможности этого плагина.",
  "marketplace.component.plugin.toggle": "Переключить плагин {{name}}",
  "marketplace.component.plugin.enabled": "Плагин {{name}} включён",
  "marketplace.component.plugin.disabled": "Плагин {{name}} выключен",
  "marketplace.component.skills.title": "Скилы",
  "marketplace.component.skills.description": "Выберите доступные агентам сценарии из этого плагина.",
  "marketplace.component.skill.toggle": "Переключить скил {{name}}",
  "marketplace.component.skill.enabled": "Скил {{name}} включён",
  "marketplace.component.skill.disabled": "Скил {{name}} выключен",
  "marketplace.component.mcp.title": "MCP-серверы",
  "marketplace.component.mcp.description":
    "Включённые серверы запускаются автоматически вместе с плагином. Выключенные здесь серверы остаются выключенными.",
  "marketplace.component.mcp.toggle": "Переключить MCP-сервер {{name}}",
  "marketplace.component.mcp.enabled": "MCP-сервер {{name}} включён",
  "marketplace.component.mcp.disabled": "MCP-сервер {{name}} выключен",
  "marketplace.toggle.conflict.title": "Не удалось изменить настройки плагина",
  "marketplace.toggle.conflict.description": "Сначала устраните конфликты настроек: {{settings}}",
  "marketplace.toggle.preserved.title": "Настройки сохранены",
  "marketplace.toggle.preserved.description": "Изменённые пользователем настройки сохранены: {{settings}}",
