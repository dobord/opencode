export const dict = {
  "marketplace.component.enabled": "Activado",
  "marketplace.component.disabled": "Desactivado",
  "marketplace.component.plugin.title": "Plugin",
  "marketplace.component.plugin.description": "Activa o desactiva todas las funciones de este plugin.",
  "marketplace.component.plugin.toggle": "Alternar plugin {{name}}",
  "marketplace.component.plugin.enabled": "{{name}} activado",
  "marketplace.component.plugin.disabled": "{{name}} desactivado",
  "marketplace.component.skills.title": "Skills",
  "marketplace.component.skills.description": "Elige qué flujos incluidos están disponibles para los agentes.",
  "marketplace.component.skill.toggle": "Alternar skill {{name}}",
  "marketplace.component.skill.enabled": "Skill {{name}} activado",
  "marketplace.component.skill.disabled": "Skill {{name}} desactivado",
  "marketplace.component.mcp.title": "Servidores MCP",
  "marketplace.component.mcp.description":
    "Los servidores activados se inician automáticamente con el plugin. Los que desactives aquí permanecen apagados.",
  "marketplace.component.mcp.toggle": "Alternar servidor MCP {{name}}",
  "marketplace.component.mcp.enabled": "Servidor MCP {{name}} activado",
  "marketplace.component.mcp.disabled": "Servidor MCP {{name}} desactivado",
  "marketplace.toggle.conflict.title": "No se pudieron cambiar los ajustes del plugin",
  "marketplace.toggle.conflict.description": "Resuelve primero los ajustes en conflicto: {{settings}}",
  "marketplace.toggle.preserved.title": "Ajustes conservados",
  "marketplace.toggle.preserved.description": "Se conservaron los ajustes modificados por el usuario: {{settings}}",
