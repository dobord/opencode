export const dict = {
  ...
  "marketplace.component.enabled": "เปิดใช้งาน",
  "marketplace.component.disabled": "ปิดใช้งาน",
  "marketplace.component.plugin.title": "ปลั๊กอิน",
  "marketplace.component.plugin.description": "เปิดหรือปิดความสามารถทั้งหมดในปลั๊กอินนี้",
  "marketplace.component.plugin.toggle": "สลับปลั๊กอิน {{name}}",
  "marketplace.component.plugin.enabled": "เปิดใช้งาน {{name}} แล้ว",
  "marketplace.component.plugin.disabled": "ปิดใช้งาน {{name}} แล้ว",
  "marketplace.component.skills.title": "สกิล",
  "marketplace.component.skills.description": "เลือกเวิร์กโฟลว์ที่รวมมาให้เอเจนต์ใช้งาน",
  "marketplace.component.skill.toggle": "สลับสกิล {{name}}",
  "marketplace.component.skill.enabled": "เปิดใช้งานสกิล {{name}} แล้ว",
  "marketplace.component.skill.disabled": "ปิดใช้งานสกิล {{name}} แล้ว",
  "marketplace.component.mcp.title": "เซิร์ฟเวอร์ MCP",
  "marketplace.component.mcp.description":
    "เซิร์ฟเวอร์ที่เปิดใช้งานจะเริ่มโดยอัตโนมัติพร้อมปลั๊กอิน ส่วนที่ปิดไว้ที่นี่จะยังคงปิดอยู่",
  "marketplace.component.mcp.toggle": "สลับเซิร์ฟเวอร์ MCP {{name}}",
  "marketplace.component.mcp.enabled": "เปิดใช้งานเซิร์ฟเวอร์ MCP {{name}} แล้ว",
  "marketplace.component.mcp.disabled": "ปิดใช้งานเซิร์ฟเวอร์ MCP {{name}} แล้ว",
  "marketplace.toggle.conflict.title": "ไม่สามารถเปลี่ยนการตั้งค่าปลั๊กอิน",
  "marketplace.toggle.conflict.description": "แก้ไขการตั้งค่าที่ขัดแย้งก่อน: {{settings}}",
  "marketplace.toggle.preserved.title": "เก็บการตั้งค่าไว้แล้ว",
  "marketplace.toggle.preserved.description": "เก็บการตั้งค่าที่ผู้ใช้แก้ไขไว้: {{settings}}",
