...
export const dict = {
  "marketplace.component.enabled": "已启用",
  "marketplace.component.disabled": "已停用",
  "marketplace.component.plugin.title": "插件",
  "marketplace.component.plugin.description": "启用或停用此插件的全部功能。",
  "marketplace.component.plugin.toggle": "切换插件 {{name}}",
  "marketplace.component.plugin.enabled": "已启用 {{name}}",
  "marketplace.component.plugin.disabled": "已停用 {{name}}",
  "marketplace.component.skills.title": "技能",
  "marketplace.component.skills.description": "选择哪些插件内工作流可供智能体使用。",
  "marketplace.component.skill.toggle": "切换技能 {{name}}",
  "marketplace.component.skill.enabled": "已启用技能 {{name}}",
  "marketplace.component.skill.disabled": "已停用技能 {{name}}",
  "marketplace.component.mcp.title": "MCP 服务器",
  "marketplace.component.mcp.description": "启用的服务器会随插件自动启动；在此停用的服务器会保持关闭。",
  "marketplace.component.mcp.toggle": "切换 MCP 服务器 {{name}}",
  "marketplace.component.mcp.enabled": "已启用 MCP 服务器 {{name}}",
  "marketplace.component.mcp.disabled": "已停用 MCP 服务器 {{name}}",
  "marketplace.toggle.conflict.title": "无法更改插件设置",
  "marketplace.toggle.conflict.description": "请先解决冲突设置：{{settings}}",
  "marketplace.toggle.preserved.title": "已保留设置",
  "marketplace.toggle.preserved.description": "已保留用户修改的设置：{{settings}}",
