...
export const dict = {
  ...
  "marketplace.component.enabled": "Enabled",
  "marketplace.component.disabled": "Disabled",
  "marketplace.component.plugin.title": "Plugin",
  "marketplace.component.plugin.description": "Turn every capability in this plugin on or off.",
  "marketplace.component.plugin.toggle": "Toggle plugin {{name}}",
  "marketplace.component.plugin.enabled": "Enabled {{name}}",
  "marketplace.component.plugin.disabled": "Disabled {{name}}",
  "marketplace.component.skills.title": "Skills",
  "marketplace.component.skills.description": "Choose which bundled workflows are available to agents.",
  "marketplace.component.skill.toggle": "Toggle skill {{name}}",
  "marketplace.component.skill.enabled": "Enabled skill {{name}}",
  "marketplace.component.skill.disabled": "Disabled skill {{name}}",
  "marketplace.component.mcp.title": "MCP servers",
  "marketplace.component.mcp.description":
    "Enabled servers start automatically with the plugin. Servers you disable here stay off.",
  "marketplace.component.mcp.toggle": "Toggle MCP server {{name}}",
  "marketplace.component.mcp.enabled": "Enabled MCP server {{name}}",
  "marketplace.component.mcp.disabled": "Disabled MCP server {{name}}",
  "marketplace.toggle.conflict.title": "Could not change plugin settings",
  "marketplace.toggle.conflict.description": "Resolve conflicting settings first: {{settings}}",
  "marketplace.toggle.preserved.title": "Settings preserved",
  "marketplace.toggle.preserved.description": "Kept user-modified settings: {{settings}}",
