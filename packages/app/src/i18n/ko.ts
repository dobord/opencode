export const dict = {
  "marketplace.component.enabled": "사용",
  "marketplace.component.disabled": "사용 안 함",
  "marketplace.component.plugin.title": "플러그인",
  "marketplace.component.plugin.description": "이 플러그인의 모든 기능을 켜거나 끕니다.",
  "marketplace.component.plugin.toggle": "플러그인 {{name}} 전환",
  "marketplace.component.plugin.enabled": "{{name}} 사용",
  "marketplace.component.plugin.disabled": "{{name}} 사용 안 함",
  "marketplace.component.skills.title": "스킬",
  "marketplace.component.skills.description": "에이전트가 사용할 수 있는 포함된 워크플로를 선택하세요.",
  "marketplace.component.skill.toggle": "스킬 {{name}} 전환",
  "marketplace.component.skill.enabled": "스킬 {{name}} 사용",
  "marketplace.component.skill.disabled": "스킬 {{name}} 사용 안 함",
  "marketplace.component.mcp.title": "MCP 서버",
  "marketplace.component.mcp.description":
    "사용 중인 서버는 플러그인과 함께 자동으로 시작됩니다. 여기서 끈 서버는 꺼진 상태로 유지됩니다.",
  "marketplace.component.mcp.toggle": "MCP 서버 {{name}} 전환",
  "marketplace.component.mcp.enabled": "MCP 서버 {{name}} 사용",
  "marketplace.component.mcp.disabled": "MCP 서버 {{name}} 사용 안 함",
  "marketplace.toggle.conflict.title": "플러그인 설정을 변경할 수 없습니다",
  "marketplace.toggle.conflict.description": "먼저 충돌하는 설정을 해결하세요: {{settings}}",
  "marketplace.toggle.preserved.title": "설정 유지됨",
  "marketplace.toggle.preserved.description": "사용자가 수정한 설정을 유지했습니다: {{settings}}",
