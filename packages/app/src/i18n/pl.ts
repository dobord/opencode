export const dict = {
  "marketplace.component.enabled": "Włączono",
  "marketplace.component.disabled": "Wyłączono",
  "marketplace.component.plugin.title": "Wtyczka",
  "marketplace.component.plugin.description": "Włącz lub wyłącz wszystkie możliwości tej wtyczki.",
  "marketplace.component.plugin.toggle": "Przełącz wtyczkę {{name}}",
  "marketplace.component.plugin.enabled": "Włączono {{name}}",
  "marketplace.component.plugin.disabled": "Wyłączono {{name}}",
  "marketplace.component.skills.title": "Umiejętności",
  "marketplace.component.skills.description": "Wybierz przepływy pracy dostępne dla agentów.",
  "marketplace.component.skill.toggle": "Przełącz umiejętność {{name}}",
  "marketplace.component.skill.enabled": "Włączono umiejętność {{name}}",
  "marketplace.component.skill.disabled": "Wyłączono umiejętność {{name}}",
  "marketplace.component.mcp.title": "Serwery MCP",
  "marketplace.component.mcp.description":
    "Włączone serwery uruchamiają się automatycznie z wtyczką. Wyłączone tutaj pozostają wyłączone.",
  "marketplace.component.mcp.toggle": "Przełącz serwer MCP {{name}}",
  "marketplace.component.mcp.enabled": "Włączono serwer MCP {{name}}",
  "marketplace.component.mcp.disabled": "Wyłączono serwer MCP {{name}}",
  "marketplace.toggle.conflict.title": "Nie udało się zmienić ustawień wtyczki",
  "marketplace.toggle.conflict.description": "Najpierw rozwiąż konflikty ustawień: {{settings}}",
  "marketplace.toggle.preserved.title": "Ustawienia zachowane",
  "marketplace.toggle.preserved.description": "Zachowano ustawienia zmienione przez użytkownika: {{settings}}",
