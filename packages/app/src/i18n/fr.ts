export const dict = {
  ...
  "marketplace.component.enabled": "Activé",
  "marketplace.component.disabled": "Désactivé",
  "marketplace.component.plugin.title": "Plugin",
  "marketplace.component.plugin.description": "Activez ou désactivez toutes les fonctionnalités de ce plugin.",
  "marketplace.component.plugin.toggle": "Basculer le plugin {{name}}",
  "marketplace.component.plugin.enabled": "{{name}} activé",
  "marketplace.component.plugin.disabled": "{{name}} désactivé",
  "marketplace.component.skills.title": "Skills",
  "marketplace.component.skills.description": "Choisissez les workflows inclus disponibles pour les agents.",
  "marketplace.component.skill.toggle": "Basculer le skill {{name}}",
  "marketplace.component.skill.enabled": "Skill {{name}} activé",
  "marketplace.component.skill.disabled": "Skill {{name}} désactivé",
  "marketplace.component.mcp.title": "Serveurs MCP",
  "marketplace.component.mcp.description":
    "Les serveurs activés démarrent automatiquement avec le plugin. Ceux désactivés ici restent arrêtés.",
  "marketplace.component.mcp.toggle": "Basculer le serveur MCP {{name}}",
  "marketplace.component.mcp.enabled": "Serveur MCP {{name}} activé",
  "marketplace.component.mcp.disabled": "Serveur MCP {{name}} désactivé",
  "marketplace.toggle.conflict.title": "Impossible de modifier les paramètres du plugin",
  "marketplace.toggle.conflict.description": "Résolvez d’abord les paramètres en conflit : {{settings}}",
  "marketplace.toggle.preserved.title": "Paramètres conservés",
  "marketplace.toggle.preserved.description": "Paramètres modifiés par l’utilisateur conservés : {{settings}}",
