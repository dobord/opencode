export const dict = {
  ...
  "marketplace.component.enabled": "Uključeno",
  "marketplace.component.disabled": "Isključeno",
  "marketplace.component.plugin.title": "Dodatak",
  "marketplace.component.plugin.description": "Uključite ili isključite sve mogućnosti ovog dodatka.",
  "marketplace.component.plugin.toggle": "Prebaci dodatak {{name}}",
  "marketplace.component.plugin.enabled": "{{name}} je uključen",
  "marketplace.component.plugin.disabled": "{{name}} je isključen",
  "marketplace.component.skills.title": "Vještine",
  "marketplace.component.skills.description": "Odaberite ugrađene tokove rada dostupne agentima.",
  "marketplace.component.skill.toggle": "Prebaci vještinu {{name}}",
  "marketplace.component.skill.enabled": "Vještina {{name}} je uključena",
  "marketplace.component.skill.disabled": "Vještina {{name}} je isključena",
  "marketplace.component.mcp.title": "MCP serveri",
  "marketplace.component.mcp.description":
    "Uključeni serveri se automatski pokreću s dodatkom. Serveri isključeni ovdje ostaju isključeni.",
  "marketplace.component.mcp.toggle": "Prebaci MCP server {{name}}",
  "marketplace.component.mcp.enabled": "MCP server {{name}} je uključen",
  "marketplace.component.mcp.disabled": "MCP server {{name}} je isključen",
  "marketplace.toggle.conflict.title": "Nije moguće promijeniti postavke dodatka",
  "marketplace.toggle.conflict.description": "Prvo riješite sukobljene postavke: {{settings}}",
  "marketplace.toggle.preserved.title": "Postavke su sačuvane",
  "marketplace.toggle.preserved.description": "Sačuvane su postavke koje je korisnik izmijenio: {{settings}}",
